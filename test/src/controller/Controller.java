...
public class Controller {
	...
	public void initController() {  //각 컴포넌트에 리스너 추가
		...
		gui.getCloseMenuItem().addActionListener();
		gui.getQuitMenuItem().addActionListener();
		gui.getCompileMenuItem().addActionListener(n);
		gui.getRunMenuItem().addActionListener();*/
	}
	...
	public void inputFile(Model model, String filePath) {  //파일 경로를 model클래스에 저장
		model.setFilePath(filePath);
		setFile(model, filePath);
	}
	private void setFile(Model model, String filePath) {  //파일 정보를 model클래스에 저장
