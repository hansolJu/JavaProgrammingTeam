	...
	public boolean compiler(){
		...
		try{
			...
			if((check = stdError.readLine())!=null){
				iscompiled = false;
				BufferedWriter out = new BufferedWriter(new FileWriter(fileName+".error"+".txt"));
				System.out.println("2 compile error occured -"+fileName+".error");
				out.write("Type Error Filename:"+fileName+".error\n\n");
				out.write(check);
				out.newLine();
				//다음줄 오류메세지 저장
